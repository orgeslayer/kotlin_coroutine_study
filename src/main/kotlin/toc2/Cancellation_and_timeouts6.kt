 ...
 *
 ...
 코루틴의 실행을 취소하는 실질적인 이유는 그 수행시간이 일정 시간을 초과한 경우입니다.
 ...
 withTimeout 함수를 이용하여 처리할 수 있습니다. 예제를 실행 시켜보면 아래와 같은 결과를 확인할 수 있습니다.
 ...
 -------------------------------------------
 참조) 'remove stack trace' region 코드를 실행하여
 출력되는 결과를 확인하면 이해하는데 도움이 됩니다.
 */
